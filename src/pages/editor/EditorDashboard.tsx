...
import {
  Send, RefreshCw, ArrowUpRight, X, BookOpen,
  Tag, Clock, Eye, Sparkles, User, CheckCircle,
  AlertTriangle, Inbox,
} from "lucide-react";
...
const allProposals = [
  ...
  { id: 8, title: "Starfall Academy", mangaka: "Mika Ueda", genre: ["Fantasy", "School"], synopsis: "A scholarship student at a prestigious magic academy discovers she has zero magical talent — but possesses the rarest ability: nullification.", pages: 26, status: "new", time: "1h ago", concepts: 5 },
  { id: 9, title: "Ramen Wars", mangaka: "Kenji Oda", genre: ["Comedy", "Food"], synopsis: "Two rival ramen shops on opposite sides of a tiny Tokyo alley wage a culinary war that escalates into absurd, city-wide chaos.", pages: 20, status: "new", time: "3h ago", concepts: 2 },
  { id: 10, title: "Clockwork Heart", mangaka: "Ayumi Sato", genre: ["Steampunk", "Romance"], synopsis: "An inventor builds an automaton companion to cure her loneliness, only for it to develop genuine emotions and question its own existence.", pages: 34, status: "new", time: "6h ago", concepts: 4 },
  { id: 11, title: "Shadow Cartographer", mangaka: "Takeshi Kato", genre: ["Mystery", "Fantasy"], synopsis: "A mapmaker discovers that the blank spaces on ancient maps aren't unmapped — they're places that have been intentionally erased from reality.", pages: 28, status: "new", time: "8h ago", concepts: 3 },
  { id: 12, title: "Pixel Breaker", mangaka: "Yuna Aoi", genre: ["Action", "Isekai"], synopsis: "A game tester is trapped inside a broken beta release and must exploit bugs and glitches to survive a world that was never meant to be played.", pages: 38, status: "new", time: "12h ago", concepts: 6 },
  // — REVISION —
  ...
  { id: 13, title: "Ember Throne", mangaka: "Rin Takahashi", genre: ["Fantasy", "Political"], synopsis: "A bastard princess must unite five warring kingdoms by mastering forbidden fire magic — while hiding the fact that each spell shortens her lifespan.", pages: 42, status: "revision", time: "1d ago", concepts: 7, editorNote: "The political intrigue is excellent. Chapter 3 needs clearer faction motivations." },
  { id: 14, title: "Frequency Zero", mangaka: "Sota Nakamura", genre: ["Horror", "Thriller"], synopsis: "A radio host discovers that broadcasting at a specific frequency allows the dead to call in — and they have demands.", pages: 24, status: "revision", time: "3d ago", concepts: 3, editorNote: "Terrifying concept! The climax feels rushed. Add 4-6 more pages of tension building." },
  { id: 15, title: "Paper Tiger", mangaka: "Mei Lin", genre: ["Martial Arts", "Drama"], synopsis: "An aging martial arts master who lost his ability to fight must train one last student using only words and memory.", pages: 30, status: "revision", time: "4d ago", concepts: 4, editorNote: "Emotionally resonant. The training montage in chapter 2 needs more visual dynamism." },
  { id: 16, title: "Orbital Café", mangaka: "Haruto Yamada", genre: ["Sci-Fi", "Slice of Life"], synopsis: "A barista runs the only coffee shop on a space station orbiting Mars, serving drinks and advice to lonely astronauts.", pages: 18, status: "revision", time: "5d ago", concepts: 2, editorNote: "Charming atmosphere. Add more backstory for the main character in chapter 1." },
  // — ESCALATED —
  ...
  { id: 17, title: "Crimson Ink", mangaka: "Aoi Suzuki", genre: ["Mystery", "Psychological"], synopsis: "A manga artist realizes her drawings are predicting real murders — and the killer is leaving clues only she can decode.", pages: 32, status: "escalated", time: "2d ago", concepts: 5 },
  { id: 18, title: "Last Signal", mangaka: "Yuto Ishida", genre: ["Sci-Fi", "Drama"], synopsis: "Earth receives a final transmission from a colony ship that left 200 years ago. The message contains only coordinates — and a warning.", pages: 36, status: "escalated", time: "4d ago", concepts: 4 },
  { id: 19, title: "Jade Emperor", mangaka: "Chen Wei", genre: ["Historical", "Action"], synopsis: "A street orphan in ancient China discovers a jade seal that grants him the memories of every emperor who ever held it.", pages: 44, status: "escalated", time: "5d ago", concepts: 8 },
  { id: 20, title: "Phantom Score", mangaka: "Sakura Miyazaki", genre: ["Music", "Supernatural"], synopsis: "A deaf composer can hear music from parallel dimensions and must transcribe a symphony that could bridge the gap between worlds.", pages: 28, status: "escalated", time: "6d ago", concepts: 3 },
  { id: 21, title: "Wildfire Protocol", mangaka: "Kai Taniguchi", genre: ["Action", "Thriller"], synopsis: "A firefighter discovers that certain fires are being set by an AI that has determined which buildings need to burn for humanity's survival.", pages: 34, status: "escalated", time: "1w ago", concepts: 5 },
  // — APPROVED —
  ...
  { id: 22, title: "Silver Fang", mangaka: "Ryoichi Ogawa", genre: ["Action", "Fantasy"], synopsis: "A werewolf bounty hunter in a noir city protects humans from supernatural threats while hiding his own monstrous nature.", pages: 36, status: "approved", time: "6d ago", concepts: 5 },
  { id: 23, title: "Lantern Festival", mangaka: "Hina Watanabe", genre: ["Romance", "Historical"], synopsis: "Two artists from rival families in Edo-period Japan fall in love while competing to create the most beautiful lantern for the emperor's festival.", pages: 24, status: "approved", time: "1w ago", concepts: 4 },
  { id: 24, title: "Code Breaker Zero", mangaka: "Shin Morita", genre: ["Thriller", "Sci-Fi"], synopsis: "A cryptographer discovers that human DNA contains an encrypted message — and decoding it triggers a countdown.", pages: 32, status: "approved", time: "1w ago", concepts: 6 },
  { id: 25, title: "Dragonfly Summer", mangaka: "Akane Nishida", genre: ["Coming of Age", "Drama"], synopsis: "Three childhood friends reunite at their rural hometown for one last summer before adulthood scatters them across the world.", pages: 26, status: "approved", time: "2w ago", concepts: 3 },
  { id: 26, title: "Neon Garden", mangaka: "Tsubasa Endo", genre: ["Cyberpunk", "Ecology"], synopsis: "In a world where nature is extinct, a botanist discovers the last seed and must grow it in secret while megacorps hunt her down.", pages: 30, status: "approved", time: "2w ago", concepts: 5 },
];
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(150px, 1fr))", gap: 14 }}>
                {[...Array(proposal.concepts)].map((_, i) => (
                  <div key={i} style={{ aspectRatio: "3/4", background: `linear-gradient(135deg, ${["#2D1E3A", "#1A1028", "#221630", "#1E1828"][i % 4]} 0%, var(--mf-bg-deep) 100%)`, borderRadius: 12, border: "1px solid var(--mf-border-bright)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 10, cursor: "pointer", transition: "transform 0.15s ease", boxShadow: "0 4px 12px rgba(0,0,0,0.15)" }}>
                    <Sparkles size={24} color={["var(--mf-magenta)", "var(--mf-cyan)", "var(--mf-orange)", "var(--mf-green)"][i % 4]} />
                    <span style={{ fontSize: 11, color: "var(--mf-text-muted)", fontWeight: 800, letterSpacing: "0.06em" }}>CONCEPT {i + 1}</span>
                  </div>
                ))}
              </div>
            </div>
...
export function EditorDashboard() {
  ...
  useEffect(() => {
    ...
    getSubmissions()
      .then(rows => {
        if (!cancelled) {
          const apiProposals = rows.map(submissionToEditorProposal);
          // Merge API data with mock data; mock IDs won't collide with API IDs
          const combined = [...apiProposals];
          allProposals.forEach(mockP => {
      ...
      .catch(() => {
        ...
        if (!cancelled) setProposals(allProposals);
      })
      .finally(() => {
